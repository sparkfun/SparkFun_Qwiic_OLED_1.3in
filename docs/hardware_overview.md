...
The OLED screen has a pixel resolution of 128 x 64, a panel size of 34.5 x 23.0 x 1.4 (mm), and an active area of 29.42 x 14.7 (mm). The driver chip is the SSD1306. More information can be found in the [datasheet](assets/board_files/SSD1306.pdf).
